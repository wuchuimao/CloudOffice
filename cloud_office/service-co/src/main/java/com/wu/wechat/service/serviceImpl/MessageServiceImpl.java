...
public class MessageServiceImpl implements MessageService {
    ...
    public void pushPendingMessage(Long processId, Long userId, String taskId) {
        ...
        WxMpTemplateMessage templateMessage = WxMpTemplateMessage.builder()
                ...
                .templateId("4xlr1oHd_-dAPw0OQUVQcIOjxWl9MGzFnKlkQUnftZs") //推送消息模板id
                .url("http://cloudofficefront.v5.idcfengye.com/#/show/"+processId+"/"+taskId)//点击模板消息要访问的网址
                .build();
    ...
    public void pushProcessedMessage(Long processId, Long userId, Integer status) {
        ...
        WxMpTemplateMessage templateMessage = WxMpTemplateMessage.builder()
                .toUser(openid)//要推送的用户openid
                .templateId("4ON4IJs0WfNbfi_YlQ4lG5429raRmrtqAjMIj0-polw")//模板id
                .url("http://cloudofficefront.v5.idcfengye.com/#/show/"+processId+"/0")//点击模板消息要访问的网址
                .build();
        JSONObject jsonObject = JSON.parseObject(process.getFormValues());
        JSONObject formShowData = jsonObject.getJSONObject("formShowData");
        StringBuffer content = new StringBuffer();
