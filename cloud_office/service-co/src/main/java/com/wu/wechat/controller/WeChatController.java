...
import com.wu.vo.wechat.BindPhoneVo;
...
public class WeChatController {
    ...
    public String authorize(@RequestParam("returnUrl") String returnUrl, HttpServletRequest request) {
        // buildAuthorizationUrl中三个参数：
        // 1. 授权路径，在哪个路径获取微信信息，wechat.userInfoUrl
        // 2. 固定值，授权参数，WxConsts.OAuth2Scope.SNSAPI_USERINFO
        // 3. 授权成功后的返回界面，传入的returnUrl
    ...
    public Result bindPhone(@RequestBody BindPhoneVo bindPhoneVo) {
        ...
        if(null != sysUser) {
            ...
            return Result.fail(ResultCodeEnum.PHONE_LOGIN_ERROR);
        }
    }
}
